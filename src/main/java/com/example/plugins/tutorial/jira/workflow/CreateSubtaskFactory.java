...
public class CreateSubtaskFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public CreateSubtaskFactory(WorkflowManager workflowManager) {
